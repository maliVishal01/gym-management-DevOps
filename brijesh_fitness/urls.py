...
urlpatterns = [
    path('create_profile/<int:user_id>/', create_missing_profile, name='create_missing_profile'),
    ...
    path('addPackage/', addPackage, name='addPackage'),          # <-- Corrected
    ...
    path('changePassword/', changePassword, name='changePassword'), # <-- Corrected
    path('editPackage/<int:pid>', editPackage, name='editPackage'),
    path('registration/', registration, name="registration"),   # <-- Corrected
